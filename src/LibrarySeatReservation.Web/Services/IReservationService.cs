namespace LibrarySeatReservation.Web.Services
{
    ...
    public interface IReservationService
    {
        ...
        List<AdminReservationItem> GetAllReservations(string statusFilter, DateTime? dateFilter, string areaFilter);
        (bool Success, string Message) AdminCancelReservation(int reservationId);
    }
}
